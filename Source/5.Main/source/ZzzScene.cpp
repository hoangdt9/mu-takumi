...
{
#if defined(__ANDROID__) || defined(MU_IOS)
	return IsAggressiveMobilePerfModeEnabled();
#else
	return false;
#endif
}
...
bool MoveMainCamera()
{
	...
	else
	{
        ...
        if (SceneFlag == MAIN_SCENE && !CameraTopViewEnable && IsAndroidHeavyOverlayVisible())
        {
            CameraViewFar = (std::max)(2100.0f, CameraViewFar * 0.78f);
        }
#endif
