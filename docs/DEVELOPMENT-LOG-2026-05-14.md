...
- **Mạng LAN + login:** chỉnh bootstrap server (xem `docs/DEVELOPMENT-LOG-2026-05-12.md` và `server-next` README) để máy dev trong LAN kết nối đúng cổng/host.
...
- Checklist host: [`../server-next/docs/IMPLEMENTATION-CHECKLIST.md`](../server-next/docs/IMPLEMENTATION-CHECKLIST.md)
