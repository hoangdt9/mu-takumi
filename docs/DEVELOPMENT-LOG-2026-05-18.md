...
Ghi tiếp từ **`DEVELOPMENT-LOG-2026-05-17.md`**. Dùng kèm **`server-next/docs/IMPLEMENTATION-CHECKLIST.md`**.
...
Apply: `server-next/scripts/apply-sql.sh` — thoát game trước khi apply; rebuild APK sau sửa `ZzzCharacter.cpp`.
...
- **`server-next/docs/IMPLEMENTATION-CHECKLIST.md`** — mục F3 00 equip preview + mg001 QA.
- **`server-next/docs/M6-GAME-TCP-CHECKLIST.md`** — F3 10 resync sau join.
- **`server-next/docs/M7-CHARACTER-PERSISTENCE-CHECKLIST.md`** — seed QA + stat point.
- **`server-next/docs/M4-M7-CHARACTER-ITEM-MIGRATION.md`** — preview parity.
