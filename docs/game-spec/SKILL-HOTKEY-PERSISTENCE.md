...
**Cast skill trên map (damage / channel):** khác với hotkey persistence — xem [`../android/MOBILE-SKILL-COMBAT-GUIDE.md`](../android/MOBILE-SKILL-COMBAT-GUIDE.md). QA MG: [`../qa/M9-mg-skill-combat.md`](../qa/M9-mg-skill-combat.md).
