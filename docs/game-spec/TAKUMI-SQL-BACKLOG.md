...
**Liên quan:** `docs/migration/TAKUMI-FULL-FILE-MIGRATION-CHECKLIST.md` §5, §11; `docs/migration/TAKUMI-MIGRATION-OPENMU-CHECKLIST.md` Phase 2; **`PHASE2-OPENMU-DATA-MODEL-MAP.md`** (mapping DDL + ADR nháp); [`tools/db-migrate/README.md`](../../tools/db-migrate/README.md).
