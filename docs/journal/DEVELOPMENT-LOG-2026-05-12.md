...
Không đổi schema hay handler trong phiên này; chỉ cập nhật checklist và liên kết tài liệu. MVP vẫn tham chiếu `server-next/docs/milestones/IMPLEMENTATION-CHECKLIST.md` (một session TCP login, join map sau `F3 03`, v.v.).
