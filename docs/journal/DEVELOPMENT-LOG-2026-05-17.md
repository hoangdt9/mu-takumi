...
Ghi tiếp từ **`DEVELOPMENT-LOG-2026-05-16.md`**. Dùng kèm **`server-next/docs/milestones/IMPLEMENTATION-CHECKLIST.md`**.
...
**Docs liên quan:** `server-next/docs/combat/M9-M8-NPC-GAMEPLAY-OWNERSHIP.md`, `server-next/docs/character/M7-CHARACTER-PERSISTENCE-CHECKLIST.md`, `server-next/docs/character/M6-GAME-TCP-CHECKLIST.md`.
