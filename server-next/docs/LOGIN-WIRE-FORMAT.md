...
- **Key material:** `Data/Dec2.dat` (SimpleModulus modulus/exponent) must match between client and `LegacyLoginHost` (`TAKUMI_DEC2_PATH` on host, `/keys/Dec2.dat` in Docker). See `../README.md` and `../../docs/ANDROID-DEV-MAC.md`.
