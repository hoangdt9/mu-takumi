...
- [x] Áp dụng trên volume cũ: `./scripts/apply-sql.sh 'postgresql://takumi:takumi@127.0.0.1:54444/takumi_runtime'` (chạy toàn bộ `sql/init/*.sql` theo thứ tự tên).
...
- [x] One-shot: `./scripts/promote-legacy-schema.sh` (hoặc `TAKUMI_LEGACY_PROMOTE_ONLY=1` + GameHost).
...
- **`docs/IMPLEMENTATION-CHECKLIST.md`** — mục M14 + Data & Migration.
- **`docs/LOGIN-WIRE-FORMAT.md`** — `F1 01` layout.
