...
./scripts/db/apply-sql.sh "$TAKUMI_PG_CONNECTION_STRING" sql/patches/016_test1_dk400_blade_master_seed.sql  # QA nếu cần
```
...
python3 ./scripts/spawn/sync-all-spawns-from-openmu.py --min-ratio 0.5
...
| 6 | (Tuỳ chọn) `./scripts/spawn/sync-monster-spawn-stack.sh` + `TAKUMI_MONSTER_SPAWN_DB=1` |
