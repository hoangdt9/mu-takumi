...
**Liên quan:** `milestones/IMPLEMENTATION-CHECKLIST.md` (M4/M7/M8/M9), `character/M4-M7-CHARACTER-ITEM-MIGRATION.md`, `social/M11-SOCIAL-WAREHOUSE-SKILLS.md`.
...
|--------|------------------|
| Opcode item (`0x22`–`0x34`, `F3 10`, `F3 E9/ED`) | `protocol/M1-PROTOCOL-PARITY-MAP.md`, `character/M4-M7-CHARACTER-ITEM-MIGRATION.md` §C |
...
| Warehouse / trade wire | `social/M11-SOCIAL-WAREHOUSE-SKILLS.md` |
