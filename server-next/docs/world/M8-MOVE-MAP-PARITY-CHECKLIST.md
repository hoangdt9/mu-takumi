...
**Phạm vi:** `server-next` + `./scripts/smoke/smoke-m8.sh` / unit. **QA APK:** [`../../docs/qa/M8-move-map.md`](../../docs/qa/M8-move-map.md) · [`../../docs/QA-MILESTONE.md`](../../docs/QA-MILESTONE.md)

**Quy ước:** `[x]` merge + smoke/unit; `[~]` một phần; `[ ]` chưa; `[-]` N/A

**Verify:** `./scripts/smoke/smoke-m8.sh --no-recreate` · catalog: `./scripts/smoke/smoke-m8-move-catalog.sh`
...
**M8 dev (scope file này): xong** (gồm P6.3). Chia sẻ handler với M9: `combat/M9-M8-NPC-GAMEPLAY-OWNERSHIP.md`.
