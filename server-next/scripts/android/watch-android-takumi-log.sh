...
echo "== Takumi Android logcat — MuPreload / MuMain / TakumiErrorReport / TakumiInvUse / TakumiSkillAtk / AndroidRuntime:E — Ctrl+C to stop =="
exec adb logcat -v threadtime \
  MuPreload:I MuMain:I TakumiErrorReport:I TakumiInvUse:I TakumiSkillAtk:I AndroidRuntime:E libc:F '*:S'
