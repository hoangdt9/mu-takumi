...
echo "  TAKUMI_CS_CONNECT_BASE=${TAKUMI_CS_CONNECT_BASE:-0} (must match ServerList.bmd group×20 on client)"
echo "  TAKUMI_CS_CONNECT_COUNT=${TAKUMI_CS_CONNECT_COUNT:-3}"
