...
if [[ -n "${OPENMU_MAPS_DIR:-}" ]]; then
  OPENMU_MAPS="$OPENMU_MAPS_DIR"
elif [[ -d "$ROOT/../../../Github/OpenMU/src/Persistence/Initialization/VersionSeasonSix/Maps" ]]; then
  OPENMU_MAPS="$ROOT/../../../Github/OpenMU/src/Persistence/Initialization/VersionSeasonSix/Maps"
else
  OPENMU_MAPS="$ROOT/../../OpenMU/src/Persistence/Initialization/VersionSeasonSix/Maps"
fi
