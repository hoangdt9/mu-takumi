...
/// <summary>Loads server decrypt keys from Dec2.dat (same search order as LegacyLoginHost).</summary>
public static class DecryptKeysLoader
{
    /// <summary>Deserialize Dec2.dat into <see cref="SimpleModulusKeys"/> for <see cref="MUnique.OpenMU.Network.PipelinedDecryptor"/>.</summary>
    public static (SimpleModulusKeys Keys, string SourceTag) LoadFromDec2OrDefault()
    {
    ...
    /// <summary>Looks for Data/Dec2.dat walking up from <paramref name="startDir"/>.</summary>
